...
public class DynamicRouteBuilder extends SpringRouteBuilder {
    ...
    static {
        ...
        routeDetails.add(new RouteDetail("routeDetail_from","route_1_id", "rest", "endpoint_from_id", "", "", "route_from","jetty:http://127.0.0.1:8282/dynamicRouterCamel", "endpoint_from", true));
        routeDetails.add(new RouteDetail("routeDetail_1_id","route_1_id", "rest", "endpoint_1_id", "-5 < 0", "routeDetail_from", "route_from","mock:result_endpoint_1_uri", "endpoint_1", true));
        ...
        routeDetails.add(new RouteDetail("routeDetail_6_id","route_1_id", "rest", "endpoint_6_id", "", "routeDetail_4_id", "route_from","mock:result_endpoint_6_uri", "endpoint_6", false));
        routeDetails.add(new RouteDetail("routeDetail_7_id","route_1_id", "rest", "endpoint_7_id", "", "routeDetail_4_id", "route_from","mock:result_endpoint_7_uri", "endpoint_7", false));
    }
